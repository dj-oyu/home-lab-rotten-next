  ...
  return (
    <main style={{ padding: '2rem', fontFamily: 'sans-serif' }}>
      ...
      <div style={{
        ...
        <h2>⚠️ 警告</h2>
        <p>このアプリケーションは<strong>教育・研究目的のみ</strong>で作成されています。</p>
        <ul>
      ...
      <div style={{ marginTop: '2rem' }}>
        <h2>環境情報</h2>
        <ul>
          <li><strong>Next.js</strong>: 15.0.0 (脆弱バージョン)</li>
          <li><strong>React</strong>: 19.0.0</li>
          <li><strong>react-server-dom-webpack</strong>: 19.0.0 (脆弱バージョン)</li>
        </ul>
      </div>
